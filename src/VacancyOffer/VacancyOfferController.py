...
from ..File.FileRepository import FileRepository


class VacancyOfferController(Controller):
    vacancy_offer_service: VacancyOfferService = VacancyOfferService(VacancyOfferRepository(), NotificationRepository(Socketio()), FileRepository())
