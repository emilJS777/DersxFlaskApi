...
class ServiceService(Service, Repository):
    ...
    def get_by_id(self, service_id: int) -> dict:
        ...
        return self.response_ok({
            ...
            'image': self.get_encode_image(service.image.filename) if service.image else None
        })

    def get_all(self, page: int, per_page: int, rubric_id: int or None, category_ids: list or None, search: str or None, creator_id: int or None) -> dict:
